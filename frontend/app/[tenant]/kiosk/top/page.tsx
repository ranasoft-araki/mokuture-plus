      ...
      >
        ...
        <div style={{ padding: "32px 80px 0", display: "flex", alignItems: "center", gap: 16, flexShrink: 0 }}>
          <div style={{
            ...
            border: "1.5px solid #1d1a15", color: "#1d1a15",
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 24, fontWeight: 500, letterSpacing: -1,
            fontFamily: "Inter, system-ui, sans-serif",
          }}>磯</div>
          <div>
            <div style={{ fontSize: 11, letterSpacing: 3.2, textTransform: "uppercase", color: "#a8a198", marginBottom: 4, fontFamily: "Inter, system-ui, sans-serif" }}>EST. 1948</div>
